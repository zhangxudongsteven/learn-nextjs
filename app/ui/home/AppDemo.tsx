...
import { AppScreen } from '@/app/ui/home/AppScreen'
      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            ...
            <div className="text-sm text-gray-900">AI分析师</div>
          ...
          <div className="mt-3 border-t border-gray-200 pt-5">
            <div className="flex items-baseline gap-2">
              ...
              <div className="text-sm text-gray-900">CNY</div>
              {percentageChange && (
                <div
                  className={clsx(
            ...
            <div className="mt-3 divide-y divide-gray-100 text-sm">
              <div className="flex justify-between py-1">
                <div className="text-gray-500">期初</div>
                <div className="font-medium text-gray-900">6,387.55</div>
              </div>
              <div className="flex justify-between py-1">
                <div className="text-gray-500">期末</div>
